...
<head>
  ...
  <title>Property Master Data MERCEDEX</title>
    ...
    <div class="container-fluid">
      ...
      <div class="col-md-12">
        ...
        <div class="pb-2 mb-3 border-bottom">
          <span class="fs-12">
            Administration • Properties • Property Master Data
          </span>
        </div>
              ...
              <div class="row">
                ...
                <div class="d-flex col-12 col-lg-6">
                  <div class="input-group">
                    <input type="text" class="form-control" placeholder="Search" ng-model="property_code">
        ...
        <div class="row">
          ...
          <div class="col-12 mt-md-0">
            <div class="row">
              <div class="col-md-8">
                <div class="col-md-12 border border-dark-subtle bg-light rounded p-4">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                      <label class="form-label mt-3">Unit Code</label>
                      <div class="col-12 d-flex align-items-center">
                        <input type="text" class="form-control" ng-model="property.property_code"
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="col-12 d-flex align-items-center">
                        <input type="text" class="form-control" ng-model="property.property_type"
                          ng-disabled="!isEditing">
                      </div>
                    </div>
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="col-12 d-flex align-items-center">
                        <input type="text" class="form-control" ng-model="property.price" ng-disabled="!isEditing">
                        <!-- <span class="fw-bold">
                        {{ customer.middlename ? customer.middlename : '---' }}
                      </span> -->
                      </div>
                    ...
                    <div class="col-md-6">
                      <label class="form-label mt-3">Unit Name</label>
                      <div class="col-12 d-flex align-items-center">
                        <input type="text" class="form-control" ng-model="property.property_name"
                          ng-disabled="!isEditing">
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="col-12 d-flex align-items-center">
                        <input type="text" class="form-control" ng-model="property.location" ng-disabled="!isEditing">
                      </div>
                    </div>
              ...
              <div class="col-md-4">
                <div class="col-12 border border-dark-subtle bg-light rounded p-4 mt-3 mt-md-0">
                  <div class="d-flex justify-content-between align-items-center">
                    <h5 class="fw-semibold mb-3">Current Owner</h5>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="col-12 d-flex align-items-center">
                        <input type="text" class="form-control" ng-model="property.accountnumber" disabled>
                        <!-- <span class="fw-bold">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="col-12 d-flex align-items-center">
                        <input type="text" class="form-control" ng-model="property.owner" disabled>
                        <!-- <span class="fw-bold">
