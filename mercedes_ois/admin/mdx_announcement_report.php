        ...
        <div class="container-fluid">
            <div class="col-md-12">
                ...
                <div class="pb-2 mb-3 border-bottom">
                    <span class="fs-12">Administration • Reports • Announcement History</span>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 d-flex align-items-end">
                                <button class="btn btn-primary w-100" ng-click="GetReport('announcement_history')">
                            ...
                            <table class="table table-hover align-middle">
                                ...
                                <tbody>
                                    <tr ng-repeat="a in data">
                                        <td>{{a.title}}</td>
                                        <td class="ref-col">{{a.message}}</td>
                                        <td>{{a.modifiedby}}</td>
                                        <td>{{a.sysentrydate}}</td>
                                        <td>
                                            <span class="badge bg-success"
                                                ng-if="a.status=='POSTED'">{{a.status}}</span>
                                            <span class="badge bg-warning text-dark"
                                                ng-if="a.status=='ACTIVE'">{{a.status}}</span>
