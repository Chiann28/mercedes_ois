...
<body class="mdx-body-color" ng-controller="AdminController" ng-init="DoAutoPostAnnouncement();">
                        ...
                        <div class="col-12 pb-3">
                            <div class="bg-light p-3 rounded">
                                <div class="d-flex align-items-center mdx-border-bottom pb-3">
                                    <h3 class="m-0 mdx-text-scarlet"><i
                                            class="fa-solid fa-money-bill-trend-up me-2"></i></h3>
                ...
                <div class="col-12 col-lg-4">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="bg-light rounded p-4">
                                <div class="d-flex justify-content-between align-items-center mdx-border-bottom pb-3">
                                    <h3 class="m-0"> <i
                                            class="fa-solid fa-calendar me-1 mdx-text-scarlet"></i>Announcements</h3>
                                ...
                                <div class="my-1">
                                    <div class="d-flex py-3 mdx-border-bottom-light">
                                        <div class="ms-3">
                                            <a href="#" class="text-decoration-none h6 mdx-text-hover">Announcement -
                                                <span class="fw-light">
                                ...
                                <div class="my-1">
                                    ...
                                    <div class="my-1">
                                        ...
                                        <div class="d-flex py-3 mdx-border-bottom-light">
                                            <div class="ms-3">
                                                <a href="#" class="text-decoration-none h6 mdx-text-hover">Announcement
                                                    - <span class="fw-light"> Lorem ipsum dolor sit amet
                                                        consectet..</span></a>
                                            </div>
                        ...
                        <div class="col-12 mt-3">
                            <div class="bg-light rounded p-4">
                                <div class="d-flex justify-content-between align-items-center mdx-border-bottom pb-3">
                                    <h3 class="m-0"> <i class="fa-solid fa-calendar me-1 mdx-text-scarlet"></i>Upcoming
                                        Events</h3>
                                    <button class="mdx-square-btn bg-light px-3 py-2 rounded">See all</button>
                                </div>
                                ...
                                <div class="my-3">
                                    <div class="d-flex py-3 mdx-border-bottom-light">
                                        <div class="ms-3">
                                            ...
                                            <p class="small mt-1">Lorem ipsum, dolor sit amet consectetur adipisicing
                                                elit. Illo praesentium,
                                                illum eum doloribus
