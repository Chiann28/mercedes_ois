      ...
      <div class="text-light">
        ...
        <div class="text-md-center mt-5 mb-5">
          <div class="col-12 col-md-6 mx-auto">
            <h3 class="fw-light w-100 fst-italic m-0">"The magic thing about home is that it feels good to leave,
          ...
          <div class="mt-4 mb-3 px-4">
            <form>
              <div class="position-relative mb-3">
                <input type="email" class="form-control mdx-login-input pe-5" id="exampleInputEmail1"
                  placeholder="username" aria-describedby="emailHelp">
                <i class="fa-regular fa-user fs-5 position-absolute top-50 end-0 translate-middle-y me-1"></i>
              </div>

              <div class="position-relative mb-2">
                <input type="password" class="form-control mdx-login-input" id="exampleInputPassword1"
                  placeholder="password">
                <i class="fa-regular fa-eye fs-5 position-absolute top-50 end-0 translate-middle-y me-1"></i>
              </div>
              <div class="mb-3 d-flex justify-content-between">
                ...
                <a href="../admin/mdx_admin_dashboard.php" class="text-decoration-none small mdx-text-scarlet">Forgot Password?</a>
              </div>

              <div class="text-md-center mt-5">
                <div class="col-6 col-md-6 mx-auto">
                  <button type="submit"
                    class="mdx-bordered-button btn rounded-pill w-100 text-decoration-underline">Login</button>
                </div>
              </div>
            </form>
          </div>
