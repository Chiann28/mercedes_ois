...
<body class="bg-light" ng-controller="UserDashboardController" ng-init="init();">

    <?php require_once '../framework/Components/mdx_user_header.php'; ?>

    <main class="">
        <div class="container-md mb-3 pb-5">
                                    ...
                                    <div class="row" style="height: 100%;">
                                        ...
                                        <div class="col-2 d-flex flex-column justify-content-center align-items-center">
                                            <i class="fa-solid fa-wine-glass"
                                                style="font-size: 5rem; color: #f6cb18"></i>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-lg-4 d-flex">
                                        <a href="MDX_U_Incident.php" class="text-decoration-none text-dark flex-fill">
                                            <div class="p-2 shadow rounded mt-3 d-flex flex-column justify-content-between h-100 lower-card"
                                                ...
                                                <div class="p-2 text-end">
                                                    <i class="fa-solid fa-triangle-exclamation lower-card-icon shake"
                                    ...
                                    <div class="col-lg-4 d-flex">
                                        <a href="MDX_U_Request.php" class="text-decoration-none text-dark flex-fill">
                                            <div class="p-2 shadow rounded mt-3 d-flex flex-column justify-content-between h-100 lower-card"
                                                style="cursor: pointer;">
                                                <div class="p-5">
