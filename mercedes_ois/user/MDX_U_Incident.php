              ...
              <div class="row">
                ...
                <div class="col-12">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="reportTitle" placeholder="Incident title"
                      ng-model="ri.title" required>
                  </div>
                </div>
                ...
                <div class="col-12">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="reportTitle" placeholder="Incident Location"
                      ng-model="ri.location" required>
                  </div>
                </div>
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
      ...
      <div class="modal-content border-0 shadow-lg rounded-3">
        <div class="modal-header border-0 p-3 border-bottom">
          ...
          <p class="text-uppercase m-0">Incident Report Ticket #{{ selectedItem.id }}</p>
